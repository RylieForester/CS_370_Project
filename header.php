...
<ul class = "nav" style="padding-top: 15px; padding-left: 420px">
    ...
    <li class = "nav-item dropdown">
        ...
        <ul class="dropdown-menu">
            <li>
                <a class="dropdown-item" href="data_import_2.php">Import Data 1</a>
            </li>
            <li>
                <a class="dropdown-item" href="data_import_3.php">Import Data 2</a>
            </li>
            <li>
                <a class="dropdown-item" href="data_import_1.php">Import Data 3</a>
            </li>
